 ...
 * @author 이승훈<br>
 * @since 23.08.21<br>
 * {@code NEOFanInfoDto}, {@code NEOStarInfoDto}등 정보 응답 객체 적용하는 JsonFilter입니다.<br>
...
public class NEOInfoDtoJsonFilter extends SimpleBeanPropertyFilter {
    ...
    /**
     * {@code NEOStarInfoDto}의 필드를 직렬화 할 지에 대한 여부를 결정하는 메소드입니다.
    ...
    /**
     * {@code NEOFanInfoDto}의 필드를 직렬화 할 지에 대한 여부를 결정하는 메소드입니다.
     * @param response 스타 정보 응답
     * @param fieldName 스타 정보 응답의 각각의 필드 명 (@JsonProperty의 name을 따라감.)
     * @return {@code boolean} 직렬화 여부
     */
