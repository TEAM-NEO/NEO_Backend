...
public class NEOFanEntity extends NEOUserEntity{
    ...
    /**
     * {@code NEOCreateFanInfoRequest}로부터 새로운 팬 엔티티를 생성하는 정적 팩토리 메소드입니다.<br>
     * 유효성 검사를 통과한 {@code NEOCreateFanInfoRequest} 객체를 삽입하면 사용할 수 있습니다. <br>
     ...
     */
    public static NEOFanEntity fromRequest(final NEOCreateFanInfoRequest request){
